...
usb.h -- Interprocess Communication with Starlet
...
Modified by mracsys. Note that the above notice wasn't in the
original source. It was pulled from ipc.h to be consistent in
